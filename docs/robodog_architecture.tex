...
\paragraph{What exists.} Eight ROS 2 packages, 171 passing tests, a MuJoCo
...
\code{robodog\_control}     & 40 & IK exactness, Jacobian, force signs, safety envelope \\
\code{robodog\_sim}         & 46 & MJCF vs URDF consistency, world geometry, physics \\
...
cannot drift. Three tests exist specifically because a bug got past a weaker
one --- the gravity-torque sign, the idle-command rate-limiter seed, and the
camera self-occlusion fraction.
