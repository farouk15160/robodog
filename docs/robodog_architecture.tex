...
problem, not a sign or architecture error. What it needs is work that only
makes sense against identified dynamics: co-tuning stance compliance, swing
timing and placement gains, contact detection instead of a fixed schedule, and
slip handling. That is deliberately outside the scope of a first architecture,
and none of it changes an interface.
\end{caveat}
...
The five-room house is 12\,$\times$\,9\,m and contains every indoor locomotion
